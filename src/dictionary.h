...
private:
    ...
    const std::map<std::string, std::variant<std::string, int, double, bool>> controlDictDefault = {
        ...
        {"totalEvacuadosXSimulacion", true},
        {"figureMortalidadXSimulacion", true},
        {"mortalidadXSimulacionPeriod", 1},
        {"mortalidadXSimulacion", true},
        {"mortalidadXSimulacionAt", std::string("1,2,3")},
    ...
    const std::map<std::string, std::string> typeControlDict = {
        ...
        {"totalEvacuadosXSimulacion", "bool"},
        {"totalEvacuadosXSimulacionAt", "string"},
        {"figureMortalidadXSimulacion", "bool"},
        {"mortalidadXSimulacion", "bool"},
        {"mortalidadXSimulacionAt", "string"},
        {"mortalidadXSimulacionPeriod", "int"},
